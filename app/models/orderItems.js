module.exports = {
    ...
    setOrderItem: async function (connection, order_id, product_id, transaction_price, quantity, discount) {
        try {
            await connection.query('INSERT INTO orders (order_id, product_id, transaction_price, quantity, discount) VALUES (?, ?, ?, ?, ?)', [order_id, product_id, transaction_price, quantity, discount]);
            return {
                success: true
            };
        } catch (ex) {
